...
import { Hero } from "@/app/templates/bento-grid/components/Hero";
  ...
  return (
    <main className="min-h-screen bg-neutral-100">
      <div className="mx-auto w-full max-w-5xl px-4 py-5 sm:px-6 lg:px-8">
        {/* Nav */}
        <header className="mb-5 flex items-center justify-between rounded-2xl border border-neutral-200 bg-white/80 px-5 py-3.5 backdrop-blur-sm">
